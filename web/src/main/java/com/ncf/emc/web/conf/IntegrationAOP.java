...
import com.ncf.emc.common.result.BaseReqVo;
import com.ncf.emc.common.util.LogIdUtil;
 ...
 * 4.方法性能：时间消耗
 *
 * @author lixiaoyong 14-7-17 下午3:06
 */
@Component
@Aspect
@Log4j2
public class IntegrationAOP {
    ...
    //    @Pointcut("execution(* com.ncf.emc.web.controller.*.*(..)) && !execution(* com.ncf.fae.asset.controller.CallbackCotroller.*(..))")
//    private void anyMethod() {
//    }
    @Pointcut("execution(* com.ncf.emc.web.controller.*.*(..))")
    private void anyMethod() {
    }
